// app/production-history/ProductionHistorySkeleton.tsx
import { Skeleton } from "@/components/ui/skeleton";

export const ProductionHistorySkeleton = () => {
  return (
        ...
        <div className="p-4 sm:p-6 border-b border-grey-5">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
              <Skeleton className="h-9 w-full sm:w-52 rounded-lg bg-grey-6" />
              <Skeleton className="h-9 w-full sm:w-40 rounded-lg bg-grey-6" />
              <Skeleton className="h-9 w-full sm:w-32 rounded-lg bg-grey-6" />
        ...
        <div className="p-4 space-y-4">
          ...
          {Array.from({ length: 5 }).map((_, index) => (
            ...
            >
              ...
              <Skeleton className="h-4 w-32 rounded bg-grey-6" />
              <Skeleton className="h-6 w-16 rounded-full bg-grey-6" />
              <Skeleton className="h-8 w-8 rounded-full bg-grey-6" />
            </div>
          ))}
