...
export async function POST(
  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          message: "Suppplier name is required",
    ...
    const apiUrl = `${BaseUrl}business/supplier/${businessId}/`;
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "Failed to create supplier",
          error: responseData.error || "Supplier creation failed",
