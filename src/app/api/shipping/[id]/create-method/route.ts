...
export async function POST(
  ...
  try {
    ...
    const apiUrl = `${BaseUrl}business/shipping/${businessId}/`;
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "Failed to create shipping",
          error: responseData.error || "Shipping creation failed",
