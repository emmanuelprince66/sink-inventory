...
export async function POST(
  ...
  try {
    ...
    const apiUrl = `${BaseUrl}campaign/sender_id/${businessId}/`;
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "Failed to create sender id",
          error: responseData.error || "sender id creation failed",
