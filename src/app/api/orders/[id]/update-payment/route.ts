...
export async function PATCH(
  ...
  try {
    ...
    const apiUrl = `${BaseUrl}order/mark-paid/${orderId}/`;
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            responseData.message || "Failed to update Order Payment status ",
          error: responseData.error || "Payment status  update failed",
