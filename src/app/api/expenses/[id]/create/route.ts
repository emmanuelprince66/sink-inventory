...
export async function POST(
  ...
  try {
    ...
    const apiUrl = `${BaseUrl}expenses/business/${businessId}/`;
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "Failed to create Expenses",
          error: responseData.error || "Expenses creation failed",
