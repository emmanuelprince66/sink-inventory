...
export async function POST(
  ...
  try {
    ...
    const apiUrl = `${BaseUrl}product/restock/${businessId}/`;
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: responseData.message || "Failed to restock product",
          error: responseData.error || "Product restocking failed",
